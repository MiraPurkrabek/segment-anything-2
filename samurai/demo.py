...
# from sam2.pose2seg_helper import prepare_video_model
...
def determine_model_cfg(model_path):
    if "large" in model_path:
        return "samurai/sam2.1_hiera_l.yaml"
    elif "base_plus" in model_path:
        return "samurai/sam2.1_hiera_b+.yaml"
    elif "small" in model_path:
        return "samurai/sam2.1_hiera_s.yaml"
    elif "tiny" in model_path:
        return "samurai/sam2.1_hiera_t.yaml"
    else:
...
def main(args):
    ...
    # model_cfg = os.path.join(os.path.dirname(__file__), "..", model_cfg)
    # predictor = prepare_video_model(args.model_path)
